...
namespace MoreMountains.TopDownEngine
{
	...
	public class CharacterTimeControl : CharacterAbility
	{
		...
		/// the chosen mode for this ability : one time will stop time for the specified duration on button press, 
		/// even if you release it, while continuous will stop time while the button is pressed, until cooldown consumption duration expiration
		...
		public virtual void TimeControlStart()
		{
			if (Cooldown.Ready())
			{
				...
				{
					Debug.Log("TimeControl Activated");
