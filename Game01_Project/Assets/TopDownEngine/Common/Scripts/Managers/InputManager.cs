...
{	
	...
	public class InputManager : MMSingleton<InputManager>
	{
		...
		///skill button
		public MMInput.IMButton ActivateSkillButton { get; protected set; }
		...
		protected virtual void InitializeButtons()
		{
			...
			ButtonList.Add(ActivateSkillButton = new MMInput.IMButton(PlayerID, "ActivateSkill", ActivateSkillButtonDown, ActivateSkillButtonPressed, ActivateSkillButtonUp));
		...
		public virtual void ActivateSkillButtonDown() { ActivateSkillButton.State.ChangeState(MMInput.ButtonStates.ButtonDown); }
		public virtual void ActivateSkillButtonPressed() { ActivateSkillButton.State.ChangeState(MMInput.ButtonStates.ButtonPressed); }
		public virtual void ActivateSkillButtonUp() { ActivateSkillButton.State.ChangeState(MMInput.ButtonStates.ButtonUp); }
