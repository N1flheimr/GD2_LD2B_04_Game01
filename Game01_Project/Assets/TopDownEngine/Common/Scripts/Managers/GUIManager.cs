...
namespace MoreMountains.TopDownEngine
{
    ...
    public class GUIManager : MMSingleton<GUIManager>
    {
        ...
        /// the game clear screen
        [Tooltip("the game clear screen")]
        ...
        public virtual void SetGameClearScene(bool state)
        {
            if (GameClearScreen != null)
            {
                GameClearScreen.SetActive(state);
                EventSystem.current.sendNavigationEvents = state;
            }
        }
