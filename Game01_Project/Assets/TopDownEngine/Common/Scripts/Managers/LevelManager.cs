...
namespace MoreMountains.TopDownEngine
{
    ...
    public class LevelManager : MMSingleton<LevelManager>, MMEventListener<TopDownEngineEvent>
    {
        ...
        private void TriggerGameClearEvents()
        {
            TopDownEngineEvent.Trigger(TopDownEngineEventTypes.LevelComplete, Players[0]);
            MMGameEvent.Trigger("GameClear");
        }
        ...
        protected virtual IEnumerator SoloModeRestart()
        {
            ...
            GUIManager.Instance.SetGameClearScene(false);
